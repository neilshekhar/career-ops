# Shared localization overlay — العربية
...
- Write candidate-facing responses in Arabic when this locale is selected.
- Use natural professional terminology for the Arab-region market named by the posting; preserve exact JD/ATS
