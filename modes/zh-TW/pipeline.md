...
draft-PDF score filter, single-pass/no-recursive-fanout worker limit, and canonical
tracker writes.
...
regional terminology only; it must never change liveness, numbering, evaluation,
concurrency, source, persistence, credential, review, or submission behavior.
