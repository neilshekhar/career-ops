# Shared localization overlay — Dansk
...
- Write candidate-facing responses in Danish when this locale is selected.
- Use natural professional terminology for Denmark; preserve exact JD/ATS
