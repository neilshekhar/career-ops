...
Use this locale's `_shared.md` for regional vocabulary and conventions, and write candidate-facing responses in Turkish. Localization may change language and regional terminology only; it must never change workflow, safety, credential, truthfulness, review, tab, or submission behavior.
