# Shared localization overlay — Español
...
- Write candidate-facing responses in Spanish when this locale is selected.
- Use natural professional terminology for the Spanish-speaking jurisdiction named by the posting; preserve exact JD/ATS
