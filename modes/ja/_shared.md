# Shared localization overlay — 日本語
...
- Write candidate-facing responses in Japanese when this locale is selected.
- Use natural professional terminology for Japan; preserve exact JD/ATS
