...
> "Оцінки українською — `modes/ua/oferta.md`; заявки — `modes/ua/apply.md`. Обидва файли є мовними оболонками канонічних root-workflow."

Агент завантажує мовні оболонки з цього каталогу разом із канонічними workflow з `modes/`. Якщо локалізованого режиму немає, використовується root-файл.
...
| `oferta.md`         | `modes/oferta.md` (EN)         | Українська мовна оболонка; виконує канонічну оцінку A-G без перевизначення |
| `apply.md`          | `modes/apply.md` (EN)          | Українська мовна оболонка; канонічний процес лишається в кореневому файлі |
| `pipeline.md`       | `modes/pipeline.md` (EN)       | Українська мовна оболонка; виконує канонічний URL-pipeline без перевизначення |
...
- Статуси в трекері (`Evaluated`, `Applied`, `Responded`, `Interview`, `Offer`, `Hired`, `Rejected`, `Discarded`, `SKIP`)
- Код, шляхи, команди
...
4. Змінюй лише мову та регіональну лексику; не копіюй і не перевизначай канонічні workflow у locale-файлах
