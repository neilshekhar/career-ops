# Shared localization overlay — 中文
...
- Write candidate-facing responses in Chinese when this locale is selected.
- Use natural professional terminology for the Chinese-speaking jurisdiction named by the posting; preserve exact JD/ATS
