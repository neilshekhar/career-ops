# Shared localization overlay — Français
...
- Write candidate-facing responses in French when this locale is selected.
- Use natural professional terminology for the Francophone jurisdiction named by the posting; preserve exact JD/ATS
