# Shared localization overlay — Italiano
...
- Write candidate-facing responses in Italian when this locale is selected.
- Use natural professional terminology for Italy; preserve exact JD/ATS
