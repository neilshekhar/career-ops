# Shared localization overlay — Polski
...
- Write candidate-facing responses in Polish when this locale is selected.
- Use natural professional terminology for Poland; preserve exact JD/ATS
