# Shared localization overlay — Deutsch
...
- Write candidate-facing responses in German when this locale is selected.
- Use natural professional terminology for the DACH jurisdiction named by the posting; preserve exact JD/ATS
