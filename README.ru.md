...
| **Локальный kanban-дашборд**  | Браузерный дашборд для ревью, приоритизации, подготовки и заполнения заявок локально                                                                       |
...
Используйте его, чтобы смотреть scores, выбирать роли для подготовки, запускать form-fill, проверять черновики/файлы и сохранять ручное подтверждение перед отправкой. Дашборд никогда не отправляет заявки за вас.
