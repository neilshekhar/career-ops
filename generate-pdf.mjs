 ...
 *
 * Usage:
 *   node career-ops/generate-pdf.mjs <input.html> <output.pdf> [--format=letter|a4] [--style=standard|conservative] [--report=NNN] [--allow-reorder] [--max-pages=N] [--strict-pages]
 *
...
async function generatePDF() {
  ...
  if (!inputPath || !outputPath) {
    console.error('Usage: node generate-pdf.mjs <input.html> <output.pdf> [--format=letter|a4] [--style=standard|conservative] [--report=NNN] [--allow-reorder] [--max-pages=N] [--strict-pages]');
    console.error('');
