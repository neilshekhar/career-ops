...
| **Локальний kanban-дашборд**  | Браузерна дошка для локального перегляду, пріоритизації, підготовки та заповнення заявок                                                        |
...
Використовуйте його для перегляду score, вибору ролей для підготовки, запуску form-fill, перевірки чернеток/файлів і ручного підтвердження перед відправкою. Дашборд ніколи не надсилає заявки за вас.
