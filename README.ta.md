...
- **வேலை வாய்ப்புகளை மதிப்பீடு** செய்யலாம் — 10 எடையிடப்பட்ட அம்சங்களைக் கொண்ட A–G மதிப்பீட்டு முறையின் மூலம்.
...
| அம்சம் | விளக்கம் |
| --- | --- |
| **Auto-Pipeline** | ஒரு URL-ஐ ஒட்டினால், முதலில் முழுமையான மதிப்பீடும் தீர்ப்பும் உருவாகும். PDF, தனிப்பயனாக்கப்பட்ட ஆவணங்கள் அல்லது விண்ணப்பப் பணிகள் தொடங்குவதற்கு முன் உங்கள் வெளிப்படையான Continue/Dashboard தேர்வுக்காக அமைப்பு காத்திருக்கும். |
...
| **Local Kanban Dashboard** | `npm run launch` மூலம் திறக்கும் localhost-only முதன்மை Review UI; Terminal TUI விருப்பத் தேர்வாகவும் உள்ளது. |
...
npx playwright install chromium   # PDF rendering + Playwright browser/liveness checks
...
/career-ops {paste a JD}   → முதலில் மதிப்பீடு + தீர்ப்பு; PDF/விண்ணப்பப் பணிக்கு உங்கள் வெளிப்படையான தொடர்ச்சி தேர்வு தேவை
...
└────────┬─────────┘
         │
┌────────▼─────────┐
│  A-G Evaluation  │  பொருத்தம், குறைபாடுகள், சம்பள ஆய்வு, STAR கதைகள்
│  (cv.md-ஐ படிக்கிறது) │
└────────┬─────────┘
         │
    ┌────┼────┐
...
முதன்மை Review UI உங்கள் கணினியில் மட்டும் இயங்கும் Kanban Dashboard:
...
<a href="https://github.com/neilshekhar/career-ops/graphs/contributors">
  <img
  src="https://contrib.rocks/image?repo=neilshekhar/career-ops"
  alt="career-ops contributors"
/>
</a>

career-ops-ஐ பயன்படுத்தி வேலை கிடைத்ததா? [உங்கள் வெற்றிக் கதையைப் பகிருங்கள்!](https://github.com/neilshekhar/career-ops/issues/new?template=i-got-hired.yml)
