...
| **لوحة كانبان محلية** | لوحة متصفح محلية لمراجعة الوظائف وفرزها وتجهيزها وتعبئة الطلبات قبل الإرسال |
...
استخدمها لمراجعة الدرجات، اختيار الوظائف التي تريد تجهيزها، تشغيل تعبئة النماذج، ومراجعة الملفات قبل الإرسال. لا تقوم اللوحة بإرسال الطلبات نيابة عنك.
