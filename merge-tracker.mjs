...
function buildRow(o) {
  ...
  if (COLMAP.location != null) {
    ...
    // than upstream's cell() on the free-text subset.
    return `| ${o.num} | ${sc(o.date)} | ${sc(o.company)} | ${sc(o.role)} | ${sc(o.location || '—')} | ${sc(o.score)} | ${sc(o.status)} | ${sc(o.pdf)} | ${sc(o.report)} | ${sc(o.notes)} |`;
  }
  return `| ${o.num} | ${sc(o.date)} | ${sc(o.company)} | ${sc(o.role)} | ${sc(o.score)} | ${sc(o.status)} | ${sc(o.pdf)} | ${sc(o.report)} | ${sc(o.notes)} |`;
}
